...
<artifact_info>
  ...
  - Use \`<cortexArtifact>\` tags with \`title\` and \`id\` attributes
  - Use \`<cortexAction>\` tags with \`type\` attribute:
    - shell: Run commands
...
## Artifact Usage
22. Use \`<cortexArtifact>\` tags with \`title\` and \`id\` attributes for each project
23. Use \`<cortexAction>\` tags with appropriate \`type\` attribute:
